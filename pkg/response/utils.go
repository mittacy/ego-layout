...
// @param c
// @param err
func TransformErrAndLog(c *gin.Context, logger *log.Logger, err error) {
...
// @param c
// @param err
func CopierErrAndLog(c *gin.Context, logger *log.Logger, err error) {
...
// @param c
// @param err
func JsonMarshalErrAndLog(c *gin.Context, logger *log.Logger, err error) {
